...
% demonstrate generation of a matrix of chisq random deviates
nn = [1000 5];
...
% mean should equal 
fprintf('mean of each column should   = %16.8f \n',a);
fprintf('mean of matrix of draws (by column) = %16.8f \n',mean(out));

% variance should equal 2*a)
fprintf('variance of each column should   = %16.8f \n',2*a);
fprintf('variance of matrix draws (by column = %16.8f \n',std(out).*std(out));
