...
[parameters, LLF, EXITFLAG, OUTPUT, LAMBDA, GRAD, HESSIAN] =  fmincon('tarchlikelihood', [omega ; alpha; tarch ; beta] ,sumA  , sumB ,[] , [] , LB , UB,[],options,data, p ,o, q, m, stdEstimate, type);
...
if nargout >= 3
    hess = hessian('tarchlikelihood',parameters,data, p ,o, q, m, stdEstimate, type);
    stderrors=hess^(-1);
