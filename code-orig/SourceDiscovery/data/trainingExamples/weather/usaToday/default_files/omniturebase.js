...
s_ut.linkInternalFilters="javascript:,usatoday.com,cars,job,career,careerbuilder,salary,pgpartner,apartments,homescape,homefinder,homegain,forsalebyowner,quickenloans,vanlines,servicemagic,medicinenet,digg,del.icio.us,newsvine,reddit,facebook"
s_ut.trackInlineStats=false
s_ut.linkLeaveQueryString=false
s_ut.linkTrackVars="None"
s_ut.linkTrackEvents="None"
...
var uourl=window.location.hostname + window.location.pathname;
if((uourl=="www.usatoday.com/default.htm") ||(uourl=="usatoday.com/default.htm"))
{s_ut.pageName='usat :/'}else{s_ut.pageName='usat :'+window.location.pathname;}
...
function s_ut_doPlugins(s_ut) {
	...
	if(s_ut.eVar23){if(!s_ut.eVar24){s_ut.eVar24=s_ut.getQueryParam('csp') + ':' +currentDate}};
	s_ut.prop3=s_ut.eVar11;
	if(!s_ut.eVar7)s_ut.eVar7=s_ut.getQueryParam('kw')	
	...
	s_ut.prop12=s_ut.getTimeParting('h','-5','2007'); 
	s_ut.prop13=s_ut.getTimeParting('d','-5','2007'); 
        s_ut.prop14=s_ut.getTimeParting('w','-5','2007');
...
s_ut.prop29=omniUsat.GetCookieValue('zagSession');
s_ut.prop14='';
s_ut.prop25='usat';
s_ut.prop47=omniUsat.GetCookieValue('RDB');
s_ut.prop48=omniUsat.GetCookieValue('rsi_seg');
...
if (omniUsat.GetCookieValue('USATINFO')){
	var strUsatOmni = omniUsat.GetCookieValue('USATINFO');
...
RDBGen= RDBAgeLow= RDBAgeHigh= RDBCou1= RDBCou2= RDBZip= RDBIncLow= RDBIncHigh= 'undefined';
var RDB = omniUsat.GetCookieValue('RDB');
if (RDB != null){
	RDBGen= decConvertFromBase(RDB.substring(18,20),16);
	RDBAgeLow= decConvertFromBase(RDB.substring(26,28),16);
	RDBAgeHigh= decConvertFromBase(RDB.substring(28,30),16);
	RDBCou1= decConvertFromBase(RDB.substring(14,16),16);
	RDBCou2= decConvertFromBase(RDB.substring(16,18),16);
	RDBZip= decConvertFromBase(RDB.substring(5,10),16);
	RDBIncLow= decConvertFromBase(RDB.substring(22,24),16);
	RDBIncHigh= decConvertFromBase(RDB.substring(24,26),16);
} 

if (RDBGen== 1){RDBGen='Male'}
if (RDBGen== 2) {RDBGen='Female'}
else {RDBGEN='~'}
RDBCou1= String.fromCharCode(RDBCou1);
RDBCou2= String.fromCharCode(RDBCou2);

s_ut.prop32= RDBGen;
s_ut.eVar16= RDBAgeLow + '-' + RDBAgeHigh;
s_ut.prop35= RDBCou1 + RDBCou2;
s_ut.prop30= RDBZip;
RDBIncRange= RDBIncLow + '-' +RDBIncHigh;
...
var zag = ParseZago(omniUsat.GetCookieValue('zagCookie'));
s_ut.prop27=zag.gci;
...
document.write('<scr'+'ipt type="text/javascript" src="http://js.usatoday.com/_common/_scripts/_revsci/populate.js"></s'+'cript>');
