...
T           =  size(data,1);                    
[parameters, LLF,EXITFLAG,OUTPUT,GRAD,HESSIAN] =  fminunc('egarchXEstLikelihood', startingvals ,options, data, p ,o, q, T, X,stdEstimate, errortype);
...
hess = hessian('egarchXlikelihood',parameters,data,p,o,q,T,X,stdEstimate,errortype);
