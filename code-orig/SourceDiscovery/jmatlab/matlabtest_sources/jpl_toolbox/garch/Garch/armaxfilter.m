...
if nargin <=5
    ...
    options=optimset(options,'Display','off','Diagnostics','off','LargeScale','off','MaxFunEvals',5000*(ma+ar),'MaxIter',1000*(ma+ar));
end
...
if nargout >=4
    stderrors=hessian('armaxfilter_likelihood',parameters,regressand , regressors, ar , ma, tau);
