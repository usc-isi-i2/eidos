...
[parameters, LLF,EXITFLAG,OUTPUT,GRAD,HESSIAN] =  fminunc('egarchEstLikelihood', startingvals ,options, data, p ,o, q, T, stdEstimate, errortype);
%[parameters, LLF, EXITFLAG, OUTPUT, LAMBDA, GRAD, HESSIAN] =  fmincon('egarchEstLikelihood', startingvals ,sumA  , sumB ,[] , [] , LB , UB,[],options, data, p ,o, q, T, stdEstimate, errortype);
...
hess = hessian('egarchlikelihood',parameters,data,p,o,q,T,stdEstimate,errortype);
