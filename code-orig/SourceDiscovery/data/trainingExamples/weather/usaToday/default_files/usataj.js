try{document.domain='usatoday.com'}catch(ignore){status='not in usatoday.com'
...
var me=us[us.length-1]
return me.src.replace(/[^/]*$/,'')},
_debugBuffer:[],
...
pajaxFallback:function(url,bod,rH,errH,timeout){this.showAjDebug(1,'pajaxFallback ',url,' -- ',body)
var purl=this.proxyPrefix+'post.ashx'
...
if(!self.XMLHttpRequest){if(self.ActiveXObject){usatAj.prototype.request=function(){return new ActiveXObject('Microsoft.XMLHTTP')}}else{usatAj.prototype.ajax=p.js}}
