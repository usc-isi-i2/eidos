...
% 
% USAGE:
%        [parameters, loglikelihood, Ht, likelihoods, stdresid, stderrors, A,B, jointscores]...
...
[dccparameters,dccllf,EXITFLAG,OUTPUT,LAMBDA,GRAD,HESSIAN]=fmincon('dcc_mvgarch_likelihood',dccstarting,ones(size(dccstarting)),[1-2*options.TolCon],[],[],zeros(size(dccstarting))+2*options.TolCon,[],[],options,stdresid,dccP,dccQ);
