...
scalaropt=optimset(scalaropt,'TolX',1e-2,'TolFun',1e-1,'Display','off','Diagnostics','off','DiffMaxChange',1e-2);
...
%Std Errors
if nargout>=6
    A=hessian('diagonal_bekk_T_likelihood',parameters,data,p,q,k,k2,t);
