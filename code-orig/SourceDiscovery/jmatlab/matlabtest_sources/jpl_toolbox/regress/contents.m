...
%     felogit_demo _demo.m: demonstrate the use of felogit.m
...
%          panel_d owig program use the data from " Introduction to the Theory and Practice of 
