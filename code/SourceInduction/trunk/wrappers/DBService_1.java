// $Id: DBService.java 23 2008-08-11 23:30:54Z ambite $
 ...
 * @date $Date: 2008-08-11 16:30:54 -0700 (Mon, 11 Aug 2008) $
 * @version $Revision: 23 $
 */
public class DBService implements Wrapper {
	...
	private List<String> getColumnNames (String tablename, String direction) {
    	String inputQuery = "SELECT argumentname FROM sourceSchema "
    		...
    		+ "ORDER BY argumentno"; // JLA, otherwise messes up the arguments!!!
    	return DB.runQuery(inputQuery).getColumnValues(0);
    }

	private String getTableName (String url, String formName) {
	...
	public Table invoke(String[] endpoint, List<String> inputTuple) {
		...
		String tablename = getTableName(url,formName);
