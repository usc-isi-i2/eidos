...
warning off;
[parameters, LLF, EXITFLAG, OUTPUT, LAMBDA, GRAD, HESSIAN] =  fmincon('garcheviewslikelihood', [omega ; alpha ; beta] ,sumA  , sumB ,[] , [] , LB , UB,'garcheviewscon',options,data, p , q, m, stdEstimate);
warning on;
