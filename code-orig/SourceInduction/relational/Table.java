...
public class Table {
	...
	public boolean insertDistinct(ArrayList<String> tuple) {
	...
	public Table distinctProjection(ArrayList<String> columns) {
	...
	public ArrayList<String> getColumnValues(int index) {
	...
	public Table randomSubsetWithoutReplacement(int count) {
		...
		ArrayList<ArrayList<String>> tuplesCopy = new ArrayList<ArrayList<String>>();
