 ...
 */
var usatAuth= new usatAj("http://my.usatoday.com/");
...
with (usatAuth) {
	...
	usatAuth.getFlashCookie= function () {
		...
		return usatAuth.flashCookieReference && flashCookieReference.getCookie && flashCookieReference.getCookie();
	};
	...
	usatAuth.getAuthStatus= function() {
		...
		this.uuRememberMe= "N";
		if (uu) {
			this.uuStatus=         getCookieStringParamValue(uu, "Status" );
