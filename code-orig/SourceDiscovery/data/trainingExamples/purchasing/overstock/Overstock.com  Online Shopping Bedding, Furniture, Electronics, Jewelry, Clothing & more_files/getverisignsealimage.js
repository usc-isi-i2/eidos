  ...
  // web server 
  seal_gif_url="http://images.overstock.com/f/102/3117/8h/www.overstock.com/img/mxc/verisignseal.gif";

  /* DON'T CHANGE BELOW */
  // dn field is your server host name that hosts the seal that must also 
  // match the SSL certificate common name 
  dn="www.overstock.com"
...

  {
    ...
    document.write("<a title='Verisign' HREF=\""+u1+"\" tabindex=\"-1\" onmousedown=\"return mouseDown();\" target=\"VRSN_Splash\"><IMG NAME=\"seal\" BORDER=\"true\" SRC=\""+seal_gif_url+"\" oncontextmenu=\"return false;\"></A>");
    ...
    if((v_ua.indexOf("msie")!=-1) && (ver>=7)) {
      ...
      if (plat >= 5.1) {
       ...
       document.write("<img alt='Verisign' src='https://extended-validation-ssl.verisign.com/dot_clear.gif'/>");
       document.write("</div>");
      }
    }
