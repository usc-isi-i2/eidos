function result = normrt_rndc(mu,sigma2,right)
% PURPOSE: CMEX to compute random draws from a right-truncated normal
%          distribution, with mean = mu, variance = sigma2
% ------------------------------------------------------
% USAGE: y = normrt_rndc(mu,sigma2,right)
% where: nobs = # of draws
...
%        calls normt_rndc with the appropriate arguments
% ------------------------------------------------------
