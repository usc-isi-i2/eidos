...
[dccparameters,dccllf,EXITFLAG,OUTPUT,LAMBDA,GRAD,HESSIAN]=fmincon('Idcc_mvgarch_likelihood',dccstarting,ones(size(dccstarting)),[1-2*options.TolCon],[],[],zeros(size(dccstarting))+2*options.TolCon,[],[],options,stdresid);
