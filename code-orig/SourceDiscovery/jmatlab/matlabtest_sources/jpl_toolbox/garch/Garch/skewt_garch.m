...
[parameters, LLF, EXITFLAG, OUTPUT, LAMBDA, GRAD, HESSIAN] =  fmincon('skewt_garchlikelihood', startingvals ,sumA  , sumB ,[] , [] , LB , UB,[],options, data, p , q, m,stdEstimate);
...
hess = hessian('skewt_garchlikelihood',parameters,data,p , q, m,stdEstimate);
